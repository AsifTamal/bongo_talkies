...
public class MovieResult {
    ...
    public  static DiffUtil.ItemCallback<MovieResult> callback= new DiffUtil.ItemCallback<MovieResult>() {
        @Override
    ...
    @BindingAdapter("android:movie_image")
    public static void loadImage(ImageView imageView, String imgUrl){
        Glide.with(imageView)
                .load(BuildConfig.IMG_URL+"/"+imgUrl)
                .fitCenter()
